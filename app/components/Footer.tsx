...
const FooterColumn = ({title, links}: ColumnProps) => (
    <div className="footer_column">
        ...
        <ul className="flex flex-col gap-2 font-normal">
            {links.map(link => (
                <Link className='w-fit' href="/" key={link}>{link}</Link>
            ))}
        </ul>
    </div>
)
        ...
        <footer className="flexStart footer">
            <div className="flex flex-col gap-12 w-full">
                <div className="flex item-start flex-col">
                    ...
                    <p className="text-start text-sm font-normal mt-5 mb-10 max-w-xs">Flexibble is the world's leading community
                ...
                <div className="flexBetween foooter_copyright text-sm lg:text-base">
